...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <div
        ref={followerRef}
        className={`fixed top-0 left-0 w-10 h-10 border border-white/50 rounded-full pointer-events-none z-[9999] -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ease-out flex items-center justify-center
