  ...
  return (
    <section id="team" className="py-32 lg:py-60 px-6 lg:px-12 bg-black">
      <div className="max-w-screen-2xl mx-auto flex flex-col items-center">
        ...
        <h2 className="text-5xl md:text-8xl mb-24 leading-none tracking-tight text-white inline-flex items-center gap-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 lg:gap-20 w-full">
          {team.map((member, index) => (
            <div key={index} className="flex flex-col items-center text-center group">
              <div className="relative w-full aspect-square mb-10 overflow-hidden rounded-full border-2 border-white/5 transition-all duration-500 group-hover:border-lime group-hover:scale-105">
                <Image
                  src={member.image}
                  alt={member.name}
                  fill
              ...
              <h3 className="text-3xl md:text-4xl text-white font-bebas mb-2 group-hover:text-lime transition-colors">
                {member.name}
              </h3>
